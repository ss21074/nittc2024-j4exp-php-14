...
<body>
    ...
    <?php
    try {
        $pdo = new PDO("pgsql:host=dpg-cq6cq24s1f4s73e07gbg-a;dbname=nittc2024_j4exp_php_14_1;username=nittc2024_j4exp_php_14_1_user;password=GO8qoM9YpAPut8mQpOSKrYePfmmmr4cQ");
